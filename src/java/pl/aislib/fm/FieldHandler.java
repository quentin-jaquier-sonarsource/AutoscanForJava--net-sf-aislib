...
public class FieldHandler extends pl.aislib.fm.forms.config.FieldHandler {
  ...
  protected void addField(IField field) {
    ...
    if (currentBuilder != null) {
      ...
      try {
        populate(currentBuilder, currentProperties);
   ...
   */
  protected void addDefaultValidator(IField field) {
    try {
      Field formField = (Field) field;
      BaseValidator validator = (BaseValidator) currentValidator.getClass().newInstance();
