...
public class FieldBigDecimalTest extends FieldTestAbstract {
  ...
  /**
   * field_001_locale: Zero big decimal.
   * @throws ValidateException if test failed.
   */
  ...
  /**
   * field_001_locale: Big decimal with fraction.
   * @throws ValidateException if test failed.
   */
  ...
  /**
   * field_001_locale: Negative big decimal.
   * @throws ValidateException if test failed.
   */
  ...
  /**
   * field_001_locale: Big decimal without thousand separator.
   * @throws ValidateException if test failed.
   */
  ...
  /**
   * field_001_locale: Big decimal with thousand separator.
   * @throws ValidateException if test failed.
   */
  ...
  /**
   * field_001_locale: Big decimal as empty string.
   */
  ...
  /**
   * field_001_locale: Invalid big decimal.
   */
  ...
  /**
   * field_002_locale: Big decimal within the range.
   * @throws ValidateException if test failed.
   */
  ...
  /**
   * field_002_locale: Start range big decimal.
   * @throws ValidateException if test failed.
   */
  ...
  /**
   * field_002_locale: End range big decimal.
   * @throws ValidateException if test failed.
   */
  ...
  /**
   * field_002_locale: Big decimal less than start range.
   */
  ...
  /**
   * field_002_locale: Big decimal greater than end range.
   */
