...
public class MyConstsClass {
  ...
  public static String STRING_PUBLIC_STATIC = "STRING_PUBLIC_STATIC";

  protected static String STRING_PROTECTED_STATIC = "STRING_PROTECTED_STATIC";

  private static String STRING_PRIVATE_STATIC = "STRING_PRIVATE_STATIC";
