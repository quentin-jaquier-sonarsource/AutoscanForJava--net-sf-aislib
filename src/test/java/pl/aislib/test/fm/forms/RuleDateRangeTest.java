...
public class RuleDateRangeTest extends RuleTestAbstract {
  ...
  public void test005Bad() {
    form = getForm("form_date_range_003");
  ...
  /**
   * Both dates are not required.
   *
   * field_001: Empty date.
   * field_002: Empty date.
   */
  public void test007Ok() {
    form = getForm("form_date_range_004");
