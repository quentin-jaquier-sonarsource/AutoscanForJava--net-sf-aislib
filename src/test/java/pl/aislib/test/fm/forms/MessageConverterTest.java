...
public class MessageConverterTest extends FormTestAbstract {
  ...
  protected void printMessages() {
    if (verbose) {
      MessageFormatConverter mfc = new MessageFormatConverter();
      mfc.addCustomProperty("version", "0.6");
      Map messages = form.getErrorMessages(mfc);
  ...
  public void test005Bad() {
    form = getForm("form_messages_005", null);
  ...
  /**
   * Expected result: rule not validated.
   */
  public void test006Bad() {
    form = getForm("form_messages_006", null);

    values.put("field_001", "abcdef");
    values.put("field_002", "ghijkl");
  ...
  /**
   * Expected result: dynamic fields not validated.
   */
  public void test007Bad() {
    form = getForm("form_messages_007", null);
  ...
  /**
   * Expected result: dynamic rule not validated.
   */
  public void test008Bad() {
    form = getForm("form_messages_008", null);

    values.put("field_001_1", "abcdef");
    values.put("field_002_1", "ghijkl");
    values.put("field_001_2", "abcdef");
    values.put("field_002_2", "ghijkl");
  ...
  /**
   * Expected result: message with choice <em>one</em>.
   */
  public void test009Bad() {
    form = getForm("form_messages_009", null);
  ...
  /**
   * Expected result: message with choice <em>many</em>.
   */
